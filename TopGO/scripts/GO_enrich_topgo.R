#!/usr/bin/env Rscript
#   Script to do GO term analysis with a R package: TopGO
# Written by Li Lei, 09-19, 2019 in Walnut Creek, CA.
# Rscript1.R
# eg. run:
...
genesOfInterest <- read.delim(interestingGenesFile,sep="\t",header=FALSE)
